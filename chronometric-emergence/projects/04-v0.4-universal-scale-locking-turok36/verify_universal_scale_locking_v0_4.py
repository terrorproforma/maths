#!/usr/bin/env python3
"""Response-level verification/rebuild for v0.4. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[2.435e+18, 246.22, 6e-46]; N='v0.4'; T='Universal Scale Locking and the Turok-36 Test'
def main():
