#!/usr/bin/env python3
"""Response-level verification/rebuild for v0.3. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[0, 1]; N='v0.3'; T='Spectral Chronometry: Universal Clock Factorisation and the Higgs-Dilaton Test'
def main():
