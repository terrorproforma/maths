#!/usr/bin/env python3
"""Response-level verification/rebuild for v1.2. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[6.57974, 2.35e-13, 0.0052743708433, 0.25]; N='v1.2'; T='Exact Selector-Threshold Matching and Nonlinear Momentum-Lattice Cascade'
def main():
