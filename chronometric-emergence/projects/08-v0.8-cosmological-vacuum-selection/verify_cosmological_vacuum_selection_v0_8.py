#!/usr/bin/env python3
"""Response-level verification/rebuild for v0.8. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[6, 24350000000.0, 2.7e-13, 1002000.0, 100200000.0, 7.5e-29, 1e-06, 612, 759, 450, 0.0289]; N='v0.8'; T='Cosmological Vacuum Selection and the Maximal Chronometric-Shear Ridge'
def main():
