...
\urlstyle{same}
\hypersetup{
  pdftitle={QCD Chronometric Lock: All-Orders Threshold Propagation and the 2/27 Signal},
  pdfauthor={Angus Muffatti},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{QCD Chronometric Lock: All-Orders Threshold Propagation and the
2/27 Signal}
...
\hypertarget{scale-invariant-quantum-definition}{%
...
\hypertarget{exact-threshold-propagation-theorem}{%
...
recursion {[}@Chetyrkin1997{]}.

\hypertarget{a-controlled-coloured-defect}{%
...
\hypertarget{the-227-transmission-coefficient}{%
...
\hypertarget{clock-and-equivalence-principle-predictions}{%
...
stated clock sensitivities {[}@ClockData2023; @ClockReview2025{]}.
...
{[}@DamourDonoghue2010; @MICROSCOPE2022{]}.

\hypertarget{the-radiative-naturalness-obstruction}{%
