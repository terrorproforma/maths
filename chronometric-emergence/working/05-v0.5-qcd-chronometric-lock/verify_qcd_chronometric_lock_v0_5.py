#!/usr/bin/env python3
"""Response-level verification/rebuild for v0.5. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[0.07407407407407407, 2, 300.76]; N='v0.5'; T='QCD Chronometric Lock: All-Orders Threshold Propagation and the 2/27 Signal'
def main():
