#!/usr/bin/env python3
"""Response-level verification/rebuild for v1.4. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[0.261356, 0.204516, 0.201417, 0.106177, 0.0119151, 0.000318544, 31918.0, 2158800.0]; N='v1.4'; T='Direct AMY LPM Transport and Full-Angle Screened Thermalisation'
def main():
