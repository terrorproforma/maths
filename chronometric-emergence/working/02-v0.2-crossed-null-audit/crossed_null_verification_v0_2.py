#!/usr/bin/env python3
"""Response-level verification/rebuild for v0.2. Author: Angus Muffatti."""
from pathlib import Path
import json,csv,numpy as np,matplotlib.pyplot as plt
R=Path(__file__).parent; V=[20000, 4]; N='v0.2'; T='Crossed-Null Chronometry: Priority Audit and Dynamical Viability Test'
def main():
