...
\begin{figure}[ht]
\centering
\input{../figures/obstruction_chart.tex}
...
\begin{figure}[ht]
\centering
\input{../figures/chairman_gadget.tex}
...
\paragraph{Provenance and attribution.}
The seven-vertex flow counterexample of Sections~3--4 is due to Dmitry Rybin,
who constructed it with GPT-5.6 Pro and announced it publicly on 22 July 2026
(\url{https://x.com/DmitryRybin1/status/2079904005652893709}); the
positive-cost variant, Morell--Skutella corollaries, and parametric $9/8$
family presented here are developments of Rybin's instance.  The chairman
counterexample of Section~5 originates from the present author's own research
session (also available standalone in
\texttt{2026-rounding-counterexamples/papers/chairman-counterexample.tex}).
Any submission of this manuscript must retain the attribution of
Sections~3--4; see \texttt{ATTRIBUTIONS.md} and \texttt{PROVENANCE\_AUDIT.md}
